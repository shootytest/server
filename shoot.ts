...
const p_launch: shoot_stats = { type: "launch", reload: 80, size: 11, speed: 9, spread: 0.015, damage: 18, health: 16, time: 5.0, };
...
const p_trap_t_basic: shoot_stats = { type: "trap_basic", reload: 120, size: 15, speed: 3, spreadv: 0.5, friction: 0.03, spread: 0.015, damage: 20, health: 30, time: 10.0, };
