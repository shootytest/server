...
const p_large: shoot_stats = { type: "basic", reload: 70, size: 11, speed: 6, spread: 0.015, damage: 20, health: 15, time: 4.0, };
const p_launch: shoot_stats = { type: "launch", reload: 80, size: 12, speed: 4, spread: 0.015, damage: 18, health: 16, time: 5.0, };
const p_sniper: shoot_stats = { type: "basic", reload: 55, size: 6, speed: 13, spread: 0.005, damage: 18, health: 6, time: 4.0, };
...
const p_trap_large: shoot_stats = { type: "trap_large", reload: 80, size: 13, speed: 4, spreadv: 0.5, friction: 0.03, spread: 0.015, damage: 20, health: 20, time: 7.0, };
